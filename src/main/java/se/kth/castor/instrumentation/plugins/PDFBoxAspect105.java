...
public class PDFBoxAspect105 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.debugger.hexviewer.HexPane",
            methodName = "getIndexForPoint",
            methodParameterTypes = {"java.awt.Point"},
            timerName = "org.apache.pdfbox.debugger.hexviewer.HexPane-getIndexForPoint")
