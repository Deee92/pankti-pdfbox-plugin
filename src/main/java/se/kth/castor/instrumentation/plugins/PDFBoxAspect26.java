...
public class PDFBoxAspect26 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.common.function.PDFunction",
            methodName = "clipToRange",
            methodParameterTypes = {"float", "float", "float"},
            timerName = "org.apache.pdfbox.pdmodel.common.function.PDFunction-clipToRange")
