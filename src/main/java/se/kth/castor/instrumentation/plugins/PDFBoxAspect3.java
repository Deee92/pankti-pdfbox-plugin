...
public class PDFBoxAspect3 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.encryption.AccessPermission",
            methodName = "isPermissionBitOn",
            methodParameterTypes = {"int"},
            timerName = "org.apache.pdfbox.pdmodel.encryption.AccessPermission-isPermissionBitOn")
