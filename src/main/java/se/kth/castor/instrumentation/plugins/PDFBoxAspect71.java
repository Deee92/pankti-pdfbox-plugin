...
public class PDFBoxAspect71 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.debugger.colorpane.IndexedTableModel",
            methodName = "getColumnClass",
            methodParameterTypes = {"int"},
            timerName = "org.apache.pdfbox.debugger.colorpane.IndexedTableModel-getColumnClass")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 71;
