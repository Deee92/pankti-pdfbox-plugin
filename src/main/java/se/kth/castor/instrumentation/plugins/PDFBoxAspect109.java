...
public class PDFBoxAspect109 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.fontbox.cmap.CMapParser",
            methodName = "createIntFromBytes",
            methodParameterTypes = {"byte[]"},
            timerName = "org.apache.fontbox.cmap.CMapParser-createIntFromBytes")
