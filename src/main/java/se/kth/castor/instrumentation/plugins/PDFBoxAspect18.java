...
public class PDFBoxAspect18 {
    @Pointcut(className = "org.apache.fontbox.cmap.CMap",
            methodName = "getCodeFromArray",
            methodParameterTypes = {"byte[]", "int", "int"},
            timerName = "org.apache.fontbox.cmap.CMap-getCodeFromArray")
