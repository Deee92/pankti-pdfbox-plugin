...
public class PDFBoxAspect132 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.color.PDCalRGB",
            methodName = "getDefaultDecode",
            methodParameterTypes = {"int"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.color.PDCalRGB-getDefaultDecode")
