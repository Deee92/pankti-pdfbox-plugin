...
public class PDFBoxAspect27 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.image.PDImageXObject",
            methodName = "clampColor",
            methodParameterTypes = {"float"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.image.PDImageXObject-clampColor")
