...
public class PDFBoxAspect44 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.shading.Line",
            methodName = "calcColor",
            methodParameterTypes = {"java.awt.Point"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.shading.Line-calcColor")
