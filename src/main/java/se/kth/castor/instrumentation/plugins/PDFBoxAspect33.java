...
public class PDFBoxAspect33 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdmodel.interactive.annotation.handlers.CloudyBorder",
            methodName = "getPolygonDirection",
            methodParameterTypes = {"java.awt.geom.Point2D$Double"},
            timerName = "org.apache.pdfbox.pdmodel.interactive.annotation.handlers.CloudyBorder-getPolygonDirection")
