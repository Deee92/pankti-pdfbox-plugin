...
public class PDFBoxAspect60 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$7",
            methodName = "blendChannel",
            methodParameterTypes = {"float", "float"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$7-blendChannel")
