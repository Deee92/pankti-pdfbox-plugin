...
public class PDFBoxAspect22 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.shading.CoonsPatch",
            methodName = "reshapeControlPoints",
            methodParameterTypes = {"java.awt.geom.Point2D"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.shading.CoonsPatch-reshapeControlPoints")
