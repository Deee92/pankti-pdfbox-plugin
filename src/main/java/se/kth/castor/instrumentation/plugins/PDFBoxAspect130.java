...
public class PDFBoxAspect130 {
    @Pointcut(className = "org.apache.pdfbox.filter.CCITTFaxEncoderStream",
            methodName = "getNextRefChanges",
            methodParameterTypes = {"int", "boolean"},
            timerName = "org.apache.pdfbox.filter.CCITTFaxEncoderStream-getNextRefChanges")
