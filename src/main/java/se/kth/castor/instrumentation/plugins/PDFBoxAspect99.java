...
public class PDFBoxAspect99 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.common.function.type4.BitwiseOperators$Or",
            methodName = "applyForBoolean",
            methodParameterTypes = {"boolean", "boolean"},
            timerName = "org.apache.pdfbox.pdmodel.common.function.type4.BitwiseOperators$Or-applyForBoolean")
