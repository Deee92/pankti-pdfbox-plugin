...
public class PDFBoxAspect63 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$12",
            methodName = "blendChannel",
            methodParameterTypes = {"float", "float"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$12-blendChannel")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 63;
