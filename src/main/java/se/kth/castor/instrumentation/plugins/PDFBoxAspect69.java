...
public class PDFBoxAspect69 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.cos.COSBoolean",
            methodName = "getValueAsObject",
            methodParameterTypes = {},
            timerName = "org.apache.pdfbox.cos.COSBoolean-getValueAsObject")
