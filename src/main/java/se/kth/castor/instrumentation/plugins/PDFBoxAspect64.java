...
public class PDFBoxAspect64 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdfparser.PDFStreamParser",
            methodName = "isSpaceOrReturn",
            methodParameterTypes = {"int"},
            timerName = "org.apache.pdfbox.pdfparser.PDFStreamParser-isSpaceOrReturn")
