...
public class PDFBoxAspect104 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.state.PDExtendedGraphicsState",
            methodName = "defaultIfNull",
            methodParameterTypes = {"java.lang.Float", "float"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.state.PDExtendedGraphicsState-defaultIfNull")
