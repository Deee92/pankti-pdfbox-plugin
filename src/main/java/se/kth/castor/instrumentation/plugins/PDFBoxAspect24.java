...
public class PDFBoxAspect24 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.debugger.streampane.tooltip.ColorToolTip",
            methodName = "getMarkUp",
            methodParameterTypes = {"java.lang.String"},
            timerName = "org.apache.pdfbox.debugger.streampane.tooltip.ColorToolTip-getMarkUp")
