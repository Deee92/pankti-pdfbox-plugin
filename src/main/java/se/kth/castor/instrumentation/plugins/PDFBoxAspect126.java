...
public class PDFBoxAspect126 {
    @Pointcut(className = "org.apache.pdfbox.preflight.process.MetadataValidationProcess",
            methodName = "hasJpegMagicNumber",
            methodParameterTypes = {"byte"},
            timerName = "org.apache.pdfbox.preflight.process.MetadataValidationProcess-hasJpegMagicNumber")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 126;
