...
public class PDFBoxAspect81 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.debugger.colorpane.CSSeparation",
            methodName = "getIntRepresentation",
            methodParameterTypes = {"float"},
            timerName = "org.apache.pdfbox.debugger.colorpane.CSSeparation-getIntRepresentation")
