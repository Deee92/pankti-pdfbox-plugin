...
public class PDFBoxAspect46 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdfparser.COSParser",
            methodName = "lastIndexOf",
            methodParameterTypes = {"char[]", "byte[]", "int"},
            timerName = "org.apache.pdfbox.pdfparser.COSParser-lastIndexOf")
