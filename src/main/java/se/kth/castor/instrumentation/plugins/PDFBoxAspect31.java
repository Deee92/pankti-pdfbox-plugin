...
public class PDFBoxAspect31 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.filter.CCITTFaxDecoderStream$Node",
            methodName = "walk",
            methodParameterTypes = {"boolean"},
            timerName = "org.apache.pdfbox.filter.CCITTFaxDecoderStream$Node-walk")
