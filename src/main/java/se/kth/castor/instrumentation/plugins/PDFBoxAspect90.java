...
public class PDFBoxAspect90 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdfparser.BaseParser",
            methodName = "isClosing",
            methodParameterTypes = {"int"},
            timerName = "org.apache.pdfbox.pdfparser.BaseParser-isClosing")
