...
public class PDFBoxAspect25 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.fontbox.cff.Type2CharStringParser",
            methodName = "getMaskLength",
            methodParameterTypes = {},
            timerName = "org.apache.fontbox.cff.Type2CharStringParser-getMaskLength")
