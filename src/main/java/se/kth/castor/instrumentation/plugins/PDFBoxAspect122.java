...
public class PDFBoxAspect122 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.fontbox.cff.CFFParser$RangeMapping",
            methodName = "isInReverseRange",
            methodParameterTypes = {"int"},
            timerName = "org.apache.fontbox.cff.CFFParser$RangeMapping-isInReverseRange")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 122;
