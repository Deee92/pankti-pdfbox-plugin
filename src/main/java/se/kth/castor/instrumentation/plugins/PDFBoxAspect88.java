...
public class PDFBoxAspect88 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.shading.Patch",
            methodName = "getFlag3Color",
            methodParameterTypes = {},
            timerName = "org.apache.pdfbox.pdmodel.graphics.shading.Patch-getFlag3Color")
