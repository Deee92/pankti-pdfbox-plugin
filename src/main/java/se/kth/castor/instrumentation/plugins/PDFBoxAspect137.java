...
public class PDFBoxAspect137 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.color.PDLab",
            methodName = "inverse",
            methodParameterTypes = {"float"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.color.PDLab-inverse")
