...
public class PDFBoxAspect124 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.color.PDDeviceGray",
            methodName = "toRGB",
            methodParameterTypes = {"float[]"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.color.PDDeviceGray-toRGB")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 124;
