...
public class PDFBoxAspect74 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.fontbox.ttf.KerningSubtable$PairData0Format0",
            methodName = "compare",
            methodParameterTypes = {"int[]", "int"},
            timerName = "org.apache.fontbox.ttf.KerningSubtable$PairData0Format0-compare")
