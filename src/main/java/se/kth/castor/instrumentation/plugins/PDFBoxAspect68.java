...
public class PDFBoxAspect68 {
    @Pointcut(className = "org.apache.pdfbox.util.Matrix",
            methodName = "getValues",
            methodParameterTypes = {},
            timerName = "org.apache.pdfbox.util.Matrix-getValues")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 68;
