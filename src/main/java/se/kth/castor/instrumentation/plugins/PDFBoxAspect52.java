...
public class PDFBoxAspect52 {
    @Pointcut(className = "org.apache.fontbox.ttf.GlyphSubstitutionTable$LookupTypeSingleSubstFormat2",
            methodName = "doSubstitution",
            methodParameterTypes = {"int", "int"},
            timerName = "org.apache.fontbox.ttf.GlyphSubstitutionTable$LookupTypeSingleSubstFormat2-doSubstitution")
