...
public class PDFBoxAspect129 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.debugger.flagbitspane.PanoseFlag",
            methodName = "getSerifStyleValue",
            methodParameterTypes = {"int"},
            timerName = "org.apache.pdfbox.debugger.flagbitspane.PanoseFlag-getSerifStyleValue")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 129;
