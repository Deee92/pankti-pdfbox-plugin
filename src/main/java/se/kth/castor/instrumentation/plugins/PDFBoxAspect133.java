...
public class PDFBoxAspect133 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.color.PDDeviceCMYK",
            methodName = "getDefaultDecode",
            methodParameterTypes = {"int"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.color.PDDeviceCMYK-getDefaultDecode")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 133;
