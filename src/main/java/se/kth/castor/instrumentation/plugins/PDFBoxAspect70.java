...
public class PDFBoxAspect70 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.debugger.colorpane.DeviceNTableModel",
            methodName = "getColumnClass",
            methodParameterTypes = {"int"},
            timerName = "org.apache.pdfbox.debugger.colorpane.DeviceNTableModel-getColumnClass")
