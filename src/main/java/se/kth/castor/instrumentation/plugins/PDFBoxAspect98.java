...
public class PDFBoxAspect98 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.common.function.type4.BitwiseOperators$And",
            methodName = "applyForBoolean",
            methodParameterTypes = {"boolean", "boolean"},
            timerName = "org.apache.pdfbox.pdmodel.common.function.type4.BitwiseOperators$And-applyForBoolean")
