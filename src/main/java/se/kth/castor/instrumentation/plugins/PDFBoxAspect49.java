...
public class PDFBoxAspect49 {
    @Pointcut(className = "org.apache.fontbox.cmap.CodespaceRange",
            methodName = "isFullMatch",
            methodParameterTypes = {"byte[]", "int"},
            timerName = "org.apache.fontbox.cmap.CodespaceRange-isFullMatch")
