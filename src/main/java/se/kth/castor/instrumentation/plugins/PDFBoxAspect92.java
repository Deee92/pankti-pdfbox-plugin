...
public class PDFBoxAspect92 {
    @Pointcut(className = "org.apache.pdfbox.text.PDFMarkedContentExtractor",
            methodName = "within",
            methodParameterTypes = {"float", "float", "float"},
            timerName = "org.apache.pdfbox.text.PDFMarkedContentExtractor-within")
