...
public class PDFBoxAspect17 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.shading.PatchMeshesShadingContext",
            methodName = "interpolate",
            methodParameterTypes = {"float", "long", "float", "float"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.shading.PatchMeshesShadingContext-interpolate")
