...
public class PDFBoxAspect56 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$1",
            methodName = "blendChannel",
            methodParameterTypes = {"float", "float"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$1-blendChannel")
