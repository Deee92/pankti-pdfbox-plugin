...
public class PDFBoxAspect15 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.common.function.PDFunction",
            methodName = "interpolate",
            methodParameterTypes = {"float", "float", "float", "float", "float"},
            timerName = "org.apache.pdfbox.pdmodel.common.function.PDFunction-interpolate")
