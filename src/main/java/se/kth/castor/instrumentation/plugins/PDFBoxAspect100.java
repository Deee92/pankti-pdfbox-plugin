...
public class PDFBoxAspect100 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdmodel.common.function.type4.BitwiseOperators$Xor",
            methodName = "applyForBoolean",
            methodParameterTypes = {"boolean", "boolean"},
            timerName = "org.apache.pdfbox.pdmodel.common.function.type4.BitwiseOperators$Xor-applyForBoolean")
