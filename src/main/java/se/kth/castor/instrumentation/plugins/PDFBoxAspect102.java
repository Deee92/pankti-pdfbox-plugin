...
public class PDFBoxAspect102 {
    @Pointcut(className = "org.apache.pdfbox.filter.LZWFilter",
            methodName = "calculateChunk",
            methodParameterTypes = {"int", "int"},
            timerName = "org.apache.pdfbox.filter.LZWFilter-calculateChunk")
