...
public class PDFBoxAspect50 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdmodel.PDAbstractContentStream",
            methodName = "isOutsideOneInterval",
            methodParameterTypes = {"double"},
            timerName = "org.apache.pdfbox.pdmodel.PDAbstractContentStream-isOutsideOneInterval")
