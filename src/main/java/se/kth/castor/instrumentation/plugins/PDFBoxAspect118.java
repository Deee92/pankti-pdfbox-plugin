...
public class PDFBoxAspect118 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.fontbox.ttf.GlyphSubstitutionTable$CoverageTableFormat2",
            methodName = "getCoverageIndex",
            methodParameterTypes = {"int"},
            timerName = "org.apache.fontbox.ttf.GlyphSubstitutionTable$CoverageTableFormat2-getCoverageIndex")
