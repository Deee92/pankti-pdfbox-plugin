...
public class PDFBoxAspect125 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.color.PDDeviceRGB",
            methodName = "toRGB",
            methodParameterTypes = {"float"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.color.PDDeviceRGB-toRGB")
