...
public class PDFBoxAspect127 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdfparser.XrefTrailerResolver",
            methodName = "getTrailer",
            methodParameterTypes = {},
            timerName = "org.apache.pdfbox.pdfparser.XrefTrailerResolver-getTrailer")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 127;
