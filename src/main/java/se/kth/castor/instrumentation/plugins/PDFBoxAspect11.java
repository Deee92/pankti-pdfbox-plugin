...
public class PDFBoxAspect11 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.fontbox.ttf.GlyfSimpleDescript",
            methodName = "getEndPtOfContours",
            methodParameterTypes = {"int"},
            timerName = "org.apache.fontbox.ttf.GlyfSimpleDescript-getEndPtOfContours")
