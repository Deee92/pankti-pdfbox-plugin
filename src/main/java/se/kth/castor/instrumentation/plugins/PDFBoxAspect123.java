...
public class PDFBoxAspect123 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.fontbox.ttf.CmapSubtable",
            methodName = "getCharCode",
            methodParameterTypes = {"int"},
            timerName = "org.apache.fontbox.ttf.CmapSubtable-getCharCode")
