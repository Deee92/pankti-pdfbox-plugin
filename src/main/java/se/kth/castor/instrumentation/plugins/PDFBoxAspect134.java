...
public class PDFBoxAspect134 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.fontbox.ttf.KerningSubtable",
            methodName = "isHorizontalKerning",
            methodParameterTypes = {"boolean"},
            timerName = "org.apache.fontbox.ttf.KerningSubtable-isHorizontalKerning")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 134;
