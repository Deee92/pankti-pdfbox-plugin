...
public class PDFBoxAspect66 {
    @Pointcut(className = "org.apache.fontbox.ttf.HorizontalMetricsTable",
            methodName = "getLeftSideBearing",
            methodParameterTypes = {"int"},
            timerName = "org.apache.fontbox.ttf.HorizontalMetricsTable-getLeftSideBearing")
