...
public class PDFBoxAspect54 {
    @Pointcut(className = "org.apache.fontbox.cff.CFFParser$Format0FDSelect",
            methodName = "getFDIndex",
            methodParameterTypes = {"int"},
            timerName = "org.apache.fontbox.cff.CFFParser$Format0FDSelect-getFDIndex")
