...
public class PDFBoxAspect35 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.PDPageContentStream",
            methodName = "isOutside255Interval",
            methodParameterTypes = {"int"},
            timerName = "org.apache.pdfbox.pdmodel.PDPageContentStream-isOutside255Interval")
