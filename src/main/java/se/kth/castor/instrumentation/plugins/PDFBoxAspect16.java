...
public class PDFBoxAspect16 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.shading.GouraudShadingContext",
            methodName = "interpolate",
            methodParameterTypes = {"float", "long", "float", "float"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.shading.GouraudShadingContext-interpolate")
