...
public class PDFBoxAspect53 {
    @Pointcut(className = "org.apache.fontbox.cff.CFFParser$Format3FDSelect",
            methodName = "getFDIndex",
            methodParameterTypes = {"int"},
            timerName = "org.apache.fontbox.cff.CFFParser$Format3FDSelect-getFDIndex")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 53;
