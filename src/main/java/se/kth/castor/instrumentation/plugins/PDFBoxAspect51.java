...
public class PDFBoxAspect51 {
    @Pointcut(className = "org.apache.fontbox.ttf.GlyphSubstitutionTable$LookupTypeSingleSubstFormat1",
            methodName = "doSubstitution",
            methodParameterTypes = {"int", "int"},
            timerName = "org.apache.fontbox.ttf.GlyphSubstitutionTable$LookupTypeSingleSubstFormat1-doSubstitution")
