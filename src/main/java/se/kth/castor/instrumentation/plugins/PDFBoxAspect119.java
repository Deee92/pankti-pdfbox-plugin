...
public class PDFBoxAspect119 {
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.shading.CoonsPatch",
            methodName = "getFlag3Edge",
            methodParameterTypes = {},
            timerName = "org.apache.pdfbox.pdmodel.graphics.shading.CoonsPatch-getFlag3Edge")
    public static class PureMethodAdvice implements AdviceTemplate {
        ...
        private static final int COUNT = 119;
