...
public class PDFBoxAspect23 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.shading.TensorPatch",
            methodName = "reshapeControlPoints",
            methodParameterTypes = {"java.awt.geom.Point2D"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.shading.TensorPatch-reshapeControlPoints")
