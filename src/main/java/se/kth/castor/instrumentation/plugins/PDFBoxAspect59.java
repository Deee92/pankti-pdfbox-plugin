...
public class PDFBoxAspect59 {
    private static int INVOCATION_COUNT;
    @Pointcut(className = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$4",
            methodName = "blendChannel",
            methodParameterTypes = {"float", "float"},
            timerName = "org.apache.pdfbox.pdmodel.graphics.blend.BlendMode$4-blendChannel")
